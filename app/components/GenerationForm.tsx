      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-md border border-gray-300 dark:border-gray-700 shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800"
      ...
      {resultImageUrl && (
        <div className="mt-8 p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
          ...
          <a 
            href={resultImageUrl} 
            download 
            className="mt-4 inline-block py-2 px-4 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md text-sm font-medium transition-colors"
          >
            Download Image
          </a>
        </div>
